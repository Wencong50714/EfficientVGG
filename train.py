...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save", type=str, default="models/model.pth", help="Path to save the model"
    )
    ...
    # Prepare data
    datasets, dataflow = prepare_data(
    ...
    if args.save.endswith(".pth"):
        ...
        save_dir = (
            args.save if os.path.isdir(args.save) else f"models/{args.save}_{timestamp}"
        )
